...
import edu.csupomona.cs480.data.provider.FScodeSubmitManager;
...
public class codeSubmitAPP {
     ...
     */
    @Bean
    public codeSubmitManager codesubmitManager() {
        codeSubmitManager codesubmitManager = new FScodeSubmitManager();
        return codesubmitManager;
    }
    ...
    public static void main(String[] args) throws Exception {
        // Run Spring Boot
        SpringApplication.run(codeSubmitAPP.class, args);
    }
}
